...
def test_create_group(client):
    ...
    # Test case 15: Test create_group function
    task = MagicMock()
    task.id = 1
    ...
    # Test case 16: Test create_group function
    task = MagicMock()
    task.id = 1
    with patch("group_management.api.create_group_task.apply_async", return_value=task):
        actual = client.post(create_group_url, data=json.dumps(request_body),
...
def test_get_status(client, mocker):
    ...
    # Test case 16: Test get_status function
    ...
    # Test case 17: Test get_status function (status is SUCCESS)
